...
SoftwareSerial NoteAcceptor(2, 3);  // RX, TX
 ...
 * SoftwareSerial NoteAcceptor(RX_PIN, TX_PIN);  // RX, TX  #include <SoftwareSerial.h>
 * NV10 PIN 1 (RS232) Tx <-> Arduino RX 2
 * NV10 PIN 5 (RS232) Rx <-> Arduino Tx 3
